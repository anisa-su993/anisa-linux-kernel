 ...
 * @seq_num: 1..n assembly-order index within the tag group, assigned by the
 *	     host at cxl_add_pending() time.  For a sharable partition the
 ...
 *	     Either way @seq_num is a dense 1..n so the dax layer can
