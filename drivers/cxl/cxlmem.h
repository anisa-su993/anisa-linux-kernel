 ...
 * @nr_pending: number of extents staged in @pending_extents; bounds the
 *		chain at CXL_DC_MAX_PENDING_EXTENTS
 ...
 * CXL r4.0 Section 8.2.10.9.9.3; Table 8-350 & Table 8-351
 */
struct cxl_mbox_dc_response {
	...
	struct updated_extent_list {
		...
		__le64 length;
		u8 reserved[8];
	} __packed extent_list[] __counted_by_le(extent_list_size);
} __packed;
